...
| LPT catalogue v3 + Stokes-V forced photometry | `lptv/` | 3 verified 2026 rows (N=16) + first systematic multi-epoch forced-V limit table at all LPT positions | 98% | **major revision** ([referee 2026-08-13](survey/lptv-findings.md)) | ⏳ forced re-measurement queued; polarization claim to be rescoped |
...
| A radio survey of the WD-pulsar candidates | `wdpulsar/` | AR Sco recover-a-known + systematic RACS/VLASS non-detection limit table | 94% | **major revision** ([referee 2026-08-13](survey/wdpulsar-findings.md)) | ⏳ forced re-measurement running; text rewrite follows the new data |
