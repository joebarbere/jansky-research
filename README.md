...
| OVRO-LWA type II burst detector | `typeii/` | slow-drift+harmonic type II detector + synthetic completeness curve (real census streams each day in memory (no disk); data on AWS Open Data) |
