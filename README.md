...
| OVRO-LWA type II burst detector | `typeii/` | slow-drift+harmonic type II detector + synthetic completeness curve (real census is a bulk-download follow-on; data on AWS Open Data) |
