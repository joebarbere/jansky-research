...
# Addendum (2026-07-05) — shortlist executed; superseded by `ideas.md`; corrections
...
The **2026-07-05 twelve-agent re-scan (`ideas.md`) is now the live opportunity file**; it
...
- **GPU avenue #3 ("OVRO-LWA solar burst detector — first ML detector on the new archive") is
  ...
  (2026), arXiv:2603.25446. Surviving angles (ideas.md F13 + its solar/ML notes): a
...
- **Tier 1 #4 (CHIME Cat 2 wait-times) — narrowed but still open.** Now published on Cat 2:
  ...
  exposure-corrected duty-cycle census across all ~83 repeaters** (ideas.md F2, bundled with
...
- **GPU avenue #5 (Apertif RFI U-Net)** — confirmed the most crowded, now with a full inventory:
  ...
  an open pure-PyTorch inference package with public weights (folded into ideas.md F6). It is
...
- **GPU avenue #4 (Zoobot/STRADAViT morphology)** — sharpened: SSL/anomaly sweeps exist for
  ...
  full 3-epoch sweep, and EMU-main have none** (ideas.md F15). STRADAViT (arXiv:2603.29660)
