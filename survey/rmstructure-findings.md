...
- **DR1 on CASDA TAP**: `AS110.spice_racs_dr1_corrected_cut_v02` = **24,758 rows** (live count —
  4× the ~5,800 figure in circulation), columns incl. `l, b, rm, rm_err, snr_polint`, no auth.
...
- Injected 2° coherence + 5× plane amplitude boost: enhancement ratio 4.64±0.35 recovered;
  low-|b| SF plateau ≫ high-|b| (6526 vs 511 rad²m⁻⁴); half-plateau break 3.7° ≈ injected scale ×
  the Gaussian-ACF factor (~1.7).
...
The plateau mixes Galactic power with intrinsic+extragalactic RM scatter → upper bound on the
Galactic term.
