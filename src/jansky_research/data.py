...
DATASETS: dict[str, Dataset] = {
    ...
    "voyager1-h5": Dataset(
        ...
        "(2016-09-19, MJD 57650.78 per its tstart; NOT the 2015-12-30 recording some write-ups "
        "use) — a real narrowband spacecraft carrier near 8419.3 MHz; the canonical SETI "
