...
1--12~GHz. The hit-density contrast spans five orders of magnitude, from
$\sim$2$\times10^{5}$ hits per scan in the worst L-band node to a C band that produced
\emph{zero} two-position survivors across 4.3~GHz. The narrowband sensitivity,
...
robust to full independent reanalysis of the released data, at matching quoted
sensitivity, across the complete 1--12~GHz coverage --- and the audit is cheap enough
