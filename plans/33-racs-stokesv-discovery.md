...
Status: 📋 planned (not started) — the highest-ceiling opener from `survey/opportunity-scan-2026-07.md`; **time-sensitive** (the ASKAP team could publish either angle within ~a year)
