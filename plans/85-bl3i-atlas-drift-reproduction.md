...
Status: 📋 planned — GATE 0 done 2026-07-30: data verified public + novelty PASS (details below).
Remaining pin at step 1: the blc-node → receiver-band mapping (read from `.h5` header attrs).
